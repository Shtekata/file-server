  ...
  return (
    ...
    >
      {type === 'file' ? (
        <a
          href={href}
          className='inline-block min-w-12 sm:min-w-19 rounded-xl text-sm text-white bg-zinc-900 px-1.5 py-1.5 font-medium sm:px-2.5 sm:py-2.5 transition hover:bg-zinc-700 dark:font-semibold dark:bg-zinc-100 dark:text-zinc-950 dark:hover:bg-white'
        >
          Get
        </a>
      ) : (
        <Link
          href={href}
          className='inline-block min-w-12 sm:min-w-19 rounded-xl text-sm text-zinc-700 px-1.5 py-1.5 sm:px-2.5 sm:py-2.5 border border-zinc-200 transition hover:text-zinc-950 dark:text-zinc-300 dark:border-white/10 dark:hover:text-zinc-100'
        >
          Open
        </Link>
      )}
