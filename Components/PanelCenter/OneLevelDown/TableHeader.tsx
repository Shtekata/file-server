    ...
    <>
      {canManage ? (
        <div className='grid grid-cols-48 border-b border-zinc-200 py-3 text-sm text-zinc-500 dark:border-white/10 dark:text-zinc-400 pl-3 pr-2'>
          <div className='col-span-14 sm:col-span-19'>Name</div>
          <div className='col-span-7 sm:col-span-7'>Size</div>
          <div className='col-span-7 sm:col-span-7'>Modified</div>
          <div className='col-span-20 sm:col-span-15 sm:text-center pl-1.5'>Action</div>
        </div>
      ) : (
        <div className='grid grid-cols-48 border-b border-zinc-200 py-3 text-sm text-zinc-500 dark:border-white/10 dark:text-zinc-400 pl-3 pr-2'>
